...
template<typename Polygon> class IMeshBuildingPolicy; ///< Forward declare the Mesh Builder

/**
* A uniform mesh consisting of a vector of polgons. Assumption is made that
